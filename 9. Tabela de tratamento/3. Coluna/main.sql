...
#Insira uma coluna na tabela sales.customers com a idade do cliente
                            ...
                            ALTER TABLE [SALES].[dbo].[customers]
                            ADD [CUSTOMER_AGE] INT 

                            SELECT * FROM [SALES].[dbo].[customers]
                            
                            UPDATE [SALES].[dbo].[customers]
...
-- Delete a coluna "age"
                            ...
                            EXEC sp_help '[SALES].[dbo].[customers]';
